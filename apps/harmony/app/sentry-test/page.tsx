...
// error type to confirm events reach the harmony Sentry project. Safe to delete
...
export default function SentryTestPage() {
  ...
  if (boom) {
    throw new Error("Sentry test — harmony render error (error-boundary path)");
  }
        ...
        <section className="flex flex-col gap-2">
          ...
          <div>
            <Button
              onClick={() => {
                throw new Error(
                  "Sentry test — harmony client error (uncaught handler)",
                );
              }}
            >
              Throw client error
